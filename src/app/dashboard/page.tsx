...
export default function DashboardPage() {
    ...
    if (!mounted) return null; // Prevent hydration mismatch for simple animations if any
                            ...
                            <nav className="flex flex-col gap-1 px-1">
                                <details className="group [&_summary::-webkit-details-marker]:hidden">
                                    ...
                                    <div className="flex flex-col gap-1 pl-[46px] pr-3 pb-2 pt-1">
                                        <Link href="#" className="text-[13px] text-[#C6F099]/80 hover:text-white hover:translate-x-1 py-1.5 transition-all block">Profil</Link>
                                        <Link href="#" className="text-[13px] text-red-300/80 hover:text-red-200 hover:translate-x-1 py-1.5 transition-all block">Sejarah</Link>
                                        <Link href="#" className="text-[13px] text-[#C6F099]/80 hover:text-white hover:translate-x-1 py-1.5 transition-all block">Visi Misi</Link>
                                    </div>
                                </details>
                                <Link href="#" className="flex w-full items-center gap-3.5 rounded-xl py-2.5 px-3 text-white/80 hover:bg-white/10 hover:text-white transition-all hover:translate-x-1 group">
                        ...
                        <div>
                            ...
                            <nav className="flex flex-col gap-1 px-1">
                                <details className="group [&_summary::-webkit-details-marker]:hidden">
                                    ...
                                    <div className="flex flex-col gap-1 pl-[46px] pr-3 pb-2 pt-1">
                                        <Link href="#" className="text-[13px] text-[#C6F099]/80 hover:text-white hover:translate-x-1 py-1.5 transition-all block">Master Pegawai</Link>
                                        <Link href="#" className="text-[13px] text-[#C6F099]/80 hover:text-white hover:translate-x-1 py-1.5 transition-all block">Data Pegawai</Link>
                                    </div>
                                </details>
                                <details className="group [&_summary::-webkit-details-marker]:hidden">
                                    <summary className="flex w-full items-center justify-between rounded-xl py-2.5 px-3 text-white/80 hover:bg-white/10 hover:text-white transition-all cursor-pointer list-none hover:translate-x-1">
                                    ...
                                    <div className="flex flex-col gap-1 pl-[46px] pr-3 pb-2 pt-1">
                                        <Link href="#" className="text-[13px] text-[#C6F099]/80 hover:text-white hover:translate-x-1 py-1.5 transition-all block">Absensi Harian</Link>
                                    </div>
                                </details>
                            </nav>
                        </div>
                        ...
                        <div>
                            ...
                            <nav className="flex flex-col gap-1 px-1">
                                <details className="group [&_summary::-webkit-details-marker]:hidden">
                                    ...
                                    <div className="flex flex-col gap-1 pl-[46px] pr-3 pb-2 pt-1">
                                        <Link href="#" className="text-[13px] text-[#C6F099]/80 hover:text-white hover:translate-x-1 py-1.5 transition-all block">Daftar Santri</Link>
                                        <Link href="#" className="text-[13px] text-[#C6F099]/80 hover:text-white hover:translate-x-1 py-1.5 transition-all block">Catatan Santri</Link>
                                    </div>
                                </details>
                                <Link href="#" className="flex w-full items-center gap-3.5 rounded-xl py-2.5 px-3 text-white/80 hover:bg-white/10 hover:text-white transition-all hover:translate-x-1 group">
                                ...
                                <Link href="#" className="flex w-full items-center gap-3.5 rounded-xl py-2.5 px-3 text-white/80 hover:bg-white/10 hover:text-white transition-all hover:translate-x-1 group">
                                    <span className="material-symbols-outlined text-[#8CC63F] text-[20px] group-hover:text-white transition-colors">emoji_events</span>
                                    <span className="font-medium text-[14px]">Prestasi</span>
                                </Link>
                            </nav>
                        </div>
